...
<form method="get" action="#">
    <br>
<p>Valor entregue: </p><input type="text" size="20" name="valor"required>
<br> <br>
<p>Valor do produto: </p><input type="text" size="20" name="total"required>
<br><br>
<input type="submit" value="Calcular"  class="btn btn-primary">
<?php
if (isset ($_GET['valor']) && isset ($_GET['total']) )
{
$valor = $_GET['valor'];
$total = $_GET['total'];
...
echo "<br><br> <p> O troco é de: $result</p>";
}
?>
</form>
</div></div>
