...
<form method="get" action="#">
    <br>
<p> Valor do quilo: </p>
<input type="text" size="20" name="valorQ"required>
<br><br>
<p> Quantidade consumida: </p>
 <input type="text" size="20" name="totalQ"required>
<br><br>
<input type="submit" value="Calcular" class="btn btn-primary">

<?php

if (isset ($_GET['valorQ']) && isset ($_GET['totalQ']) )
{
$valorQ = $_GET['valorQ'];
$totalQ = $_GET['totalQ'];

$result = $valorQ * $totalQ;

echo "<br><br><p> O preço a ser pago é de: $result reais </p>";
}
?>
</form>
</div>
